# An old file that I did not integrate into RNPFind. But maybe it has potential? (probably not to anyone else)
...
def per_binding_site_analysis(big_storage, rna_info):
    ...
    return
    # TODO:This function needs to be reconsidered with respect to RNPFind and generalized for one template
    #
    # binding_info = {}
    #
